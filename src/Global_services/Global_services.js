...
var base_url ='';
base_url= is_prod ? 'https://ec2-35-153-50-38.compute-1.amazonaws.com:4000' : 'https://localhost:4000';
...
class Global_services extends React.Component {
    ...
    static search_invoice_by_number = base_url+'/search_invoice_by_number';
