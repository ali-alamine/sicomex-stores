...
const Popup = ({record, pin_supplier,un_pin_supplier,delete_supplier,open_edit_sup_modal,setup_partial_amount_payment, visible, x, y}) => visible &&
  <ul className="popup"  id='popupMenu' style={{left: `${x}px`, top: `${y}px`}}>
    ...
    <li onClick={() =>setup_partial_amount_payment(record)}> <CreditScoreIcon /> Paiement partiel</li>
